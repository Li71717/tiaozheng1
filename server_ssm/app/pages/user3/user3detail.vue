<template>
	<view>
		<u-navbar :title="fobj.fname" :border="true" :placeholder="true"   :autoBack="true"></u-navbar>
		<scroll-view :enable-flex="true" class="svcontainer">
      <image style="width: 50%;margin-left: 25%;" class="showimg" :src="fileUrl+fobj.img" mode="widthFix"></image>
			 <view class="formitem">
      ...
      <view class="formitem">
          <u-button type="primary" @click="toChat" text="咨询聊天"></u-button>
      </view>
...
<!--				<navigator url="#" class="gmbtn" @click="user3Goods(fobj.id)">服务列表</navigator>-->
	...
	export default {
      ...
      toChat(){
          uni.ytool.toChatUni(this.fobj.id)
			...
			fobjDetail() {
				findj({params: {table: 'user', id: this.id}}).then(res => {
					this.fobj = res
